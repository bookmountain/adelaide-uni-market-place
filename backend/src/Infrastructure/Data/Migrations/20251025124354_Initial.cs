        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_chat_messages_items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_chat_messages_users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_chat_messages_users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_listing_images_items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "items",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_chat_messages_FromUserId",
                table: "chat_messages",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_chat_messages_ItemId",
                table: "chat_messages",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_chat_messages_ThreadId_SentAt",
                table: "chat_messages",
                columns: new[] { "ThreadId", "SentAt" });

            migrationBuilder.CreateIndex(
                name: "IX_chat_messages_ToUserId",
                table: "chat_messages",
                column: "ToUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_items_SellerId_Status",
                table: "items",
                columns: new[] { "SellerId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_listing_images_ItemId_SortOrder",
